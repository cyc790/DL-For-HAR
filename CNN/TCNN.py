...
def load_data(type='train', prefix=r'/Users/cyc/Desktop/'):
    ...
    for first_level_path in first_level_paths:
        ...
        second_level_paths = [ dir for dir in os.listdir(first_level) if dir in t_motions and os.path.isdir(os.path.join(first_level, dir)) ]
        for second_level_path in second_level_paths:
            ...
            for third_level_path in third_level_paths:
                ...
                for file in files:
                    ...
                    if second_level_path in t_falls:
                        falls.append(file_path)
                    elif second_level_path in t_adls:
                    ...
                    # trainX.append(data)
                    # trainY.append([1,0] if second_level_path in falls else [0,1])
    print('falls num:', len(falls))
    print('adls num:', len(adls))
    ...
    #     trainX.append(data)
    #     trainY.append([0,1])
    print('num trainX:', len(trainX))
    print('num trainY:', len(trainY))
